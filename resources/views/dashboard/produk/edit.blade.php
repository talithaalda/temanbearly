        ...
        <div class="container-fluid ">
            <div class="wrapper row">
                ...
                <div class="preview-pic tab-content mb-5 card" style="width: 500px;height: 500px">
                    <form method="post" action="/dashboard/products/edit/{{ $produk->id }}" class="md-form" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <input type="hidden" name="oldImage" value="{{ $produk->image }}">
                        <img class="" src="{{ asset("storage/$produk->image") }}" width="500" height="500">
                ...
                <div class="details col-md-6">
                    <div class="mb-3">
                        ...
                        style="height: 50px; font-size:28px;"  required autofocus value="{{ old('namaproduk',$produk->namaproduk) }}"> 
                    </div>
                    <div class="mb-3">
                        <label for="slug" class="form-label">Slug</label>
                        <input type="text" class="form-control" name="slug"  
                        required autofocus value="{{ old('slug',$produk->slug) }}"> 
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="merk" required autofocus value="{{ old('merk',$produk->merk) }}" style="font-size:18px;" >
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        required autofocus value="{{ old('harga', number_format($produk->harga, 0, ".", ".")  ) }}" style="font-size:24px;">
                    </div>
                    <div class="mb-3">
                        <label for="stok">Quantity :</label>
                        <input type="number" id="stok" name="stok" min="0" max={{ $produk->stok }}  required autofocus value="{{ old('stok',$produk->stok) }}">
                    </div>
