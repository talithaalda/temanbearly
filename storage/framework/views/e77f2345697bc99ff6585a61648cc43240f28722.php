        ...
        <div class="col-xl-10 ">
            <div class="card shadow-lg ">
                <div class="text-center mt-5">
                    ...
                    <h2 class="mb-5">Rp <?php echo e(number_format($order->total, 0, ".", ".")); ?></h2>
                    ...
                    <dt class="mt-3">Method : <?php echo e($order->methodpay); ?></dt>
                    <?php if($order->methodpay=="Dana"): ?>
                    <dl>
                    <dd>- 08123111380 a/n teman bearly beauty</dd>
                    <?php elseif(($order->methodpay=="Ovo")): ?>
                    <dd>- 08123111380 a/n teman bearly beauty</dd>
                    <?php elseif(($order->methodpay=="Gopay")): ?>
                    <dd>- 08123111380 a/n teman bearly beauty</dd>
                    <?php elseif(($order->methodpay=="BCA")): ?>
                    <dd>- 8735089032 a/n teman bearly beauty</dd>
                    <?php elseif(($order->methodpay=="Mandiri")): ?>
                    <dd>- 1410018488403 a/n teman bearly beauty</dd>
                    </dl>
                    <?php endif; ?>

                <form method="post" action="/checkout/<?php echo e($order->id); ?>" class="md-form" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" type="file" id="image" name="nota" onchange="previewImage()">
                        <?php $__errorArgs = ['nota'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="invalid-feedback">Please input your nota</div> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\pemweb\temanbearly-app\resources\views/checkout/detail.blade.php ENDPATH**/ ?>