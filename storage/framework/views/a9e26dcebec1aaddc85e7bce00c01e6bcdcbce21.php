                    ...
                    <div class="col-md-5">
                        <div class="card border-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col justify-content-between">
                                  <div class="space mb-0 "><p><b>Method : </b><?php echo e($checkout->methodpay); ?>

                                    <?php if($checkout->nota==null): ?>
                                        <br><a href="/confirm/<?php echo e($checkout->id); ?>">Click here to upload nota</a>
                                    <?php else: ?>
                                    <br><img class=" img-fluid col-sm-7" src="<?php echo e(asset("storage/".$checkout->nota)); ?>" width="200">
                                    <?php endif; ?>
                                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\pemweb\temanbearly-app\resources\views/profile/detail.blade.php ENDPATH**/ ?>