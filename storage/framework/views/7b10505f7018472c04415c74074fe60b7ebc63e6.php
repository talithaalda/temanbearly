...
<link rel="stylesheet" href="/js/script.js">
    ...
    <div class = "container">
        ...
        <div class = "order-lg-2 nav-btns">
            ...
            <a href="/cart">
                <button type = "button" class = "btn position-relative" >
                    <i class = "fa fa-shopping-cart"></i>
                        <span class = "position-absolute top-0 start-100 translate-middle badge bg-primary" style="background-color: #e5345b"><?php echo e($item); ?></span>
                </button>
                </a>
            <?php endif; ?>
        </div>
    ...
    <ul class = "navbar-nav text-right active order-lg-2">
        <li class = "nav-item">
            <a class = "nav-link text-uppercase text-dark <?php echo e(($active == "dashboard") ?'active': ' '); ?>" href = "/login" ><i class="bi bi-box-arrow-right"></i>Log in &emsp;&emsp;</a>
        </li>
    </ul>
    <?php endif; ?>
        </a>
...
<?php /**PATH D:\pemweb\temanbearly-app\resources\views/partials/navbar.blade.php ENDPATH**/ ?>