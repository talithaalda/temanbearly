        ...
        <div class = "row text-white g-4">
            ...
            <div class = "col-md-6 col-lg-3">
                ...
                <ul class = "list-unstyled">
                    ...
                    <li class = "my-3">
                        <a href = "/produk" class = "text-white text-decoration-none text-muted">
            ...
            <div class = "col-md-6 col-lg-3">
                ...
                <div class = "d-flex justify-content-start align-items-start my-2 text-muted">
                    ...
                    <span class = "fw-light">
                        Perumahan Griya Kartika Blok S-3, Desa Cemandi, Kecamatan Sedati, Kabupaten Sidoarjo
                    </span>
                </div>
                <div class = "d-flex justify-content-start align-items-start my-2 text-muted">
                    <span class = "me-3">
                    ...
                    <ul class = "list-unstyled d-flex">
                        ...
                        <li>
                            <a href = "https://www.tokopedia.com/tbearly?source=universe&st=product" class = "text-white text-decoration-none text-muted fs-4 me-4">
                                <img src="<?php echo e(asset("img/tokopedia.png")); ?>" alt="" width="45px">
                            </a>
                        </li>
                    </ul>
                </div>
...
<!-- end of footer --><?php /**PATH D:\pemweb\temanbearly-app\resources\views/partials/footer.blade.php ENDPATH**/ ?>