...
<nav id="Nav" class="col-md-3 col-lg-2 d-md-block bg-primary sidebar collapse active">
    <div class=" position-sticky pt-3">
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo e(Request::is('dashboard/orders*')?'active' :''); ?>" href="/dashboard/orders">
            <span data-feather="file-text" style="color: white"></span>
           Orders
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e(Request::is('dashboard/user*')?'active' :''); ?>" href="/dashboard/user">
          <span data-feather="file-text" style="color: white"></span>
         Users
      </a>
    </li>
  ...
  </nav><?php /**PATH D:\pemweb\temanbearly-app\resources\views/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>